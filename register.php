...
<head>
    ...
    <title>yourHOME - Registrarse</title>
            ...
            $("#register").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        } else if (html == 'false') {//si ya existe el email
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Email Address</strong> already in system. \ \
                                                 </div>');                    

                        } else if (html == 'fname') {//si han dejado el nombre en blanco
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>First Name</strong> is required. \ \
                                                 </div>');
												 
						} else if (html == 'lname') {//si han dejado el apellido en blanco
                            $("#add_err2").html('<div class="alert alert-danger"> \
						...
						} else if (html == 'pshort') {//contrasena corta
                            $("#add_err2").html('<div class="alert alert-danger"> \
                ...
                <div class="col-lg-12">
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                <button type="submit" class="btn btn-default" id="register">Enviar</button>
                            </div>
                        </div>
                    </form>
                </div>
